...
<div class="tp_-_box" data-tp-settings="domainId:7844526,showComplementaryText:False,showDate:False,numOfReviews:10,useDynamicHeight:False,height:1555">
    ...
    <div class="col-md-3">
        <div class="panel panel-gecko model" data-model="{{ $model->id }}" id="model-{{ $model->id }}" data-baseprice="{{ $model->base_price }}">
            <div class="panel-body">
                <a class="select-model" data-model="{{ $model->id }}" data-baseprice="{{ $model->base_price }}" href="#" onclick="hideImage();">
                    <img src="/assets/images/products/{{ $model->id }}.png" alt="{{ $model->name }}">
                </a>
            </div>
            <div class="panel-footer">
                <a class="select-model" data-model="{{ $model->id }}" data-baseprice="{{ $model->base_price }}" href="#" onclick="hideImage();">{{ $product->name }} <small>{{ $model->name }}</small></a>
            </div>
        </div>
    </div>
    @endforeach
