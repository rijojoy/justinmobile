...
@section('breadcrumbs')
    <?php $breadcrumbs = array(
        ...
        ['icon' => 'edit', 'label' => 'Edit', 'url' => "products/{$product->id}/models/{$model->id}/properties/{$property->id}/edit"],     
    ); ?>
    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                {{ Form::model($property, array('url' => '/admin/products/' . $product->id . '/models/' . $model->id . '/properties/' . $property->id, 'method' => 'put', 'class' => 'form-horizontal fill-up', 'files' => true)) }}
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="padded separate-sections">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {{ Form::select('type', array('single' => 'Single', 'multi' => 'Multiple'), null, array('class' => 'uniform')) }}
                                ...
                                <div class="form-actions">
                                    {{ Form::button('Update Property', array('type' => 'submit', 'class' => 'btn btn-blue')) }}
                                </div>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="padded separate-sections">
                            ...
                            <div class="form-actions">
                                {{ Form::button('<i class="icon-trash"></i> Delete', array('type' => 'submit', 'class' => 'btn btn-sm btn-red form-confirm', 'data-confirm' => 'Are you sure you want to delete this property and options permanently?')) }}
                            </div>
                            {{ Form::close() }}
                        </ul>
                    </div>
