...
<div class="action-nav-normal action-nav-line">
    <div class="row action-nav-row">
       ...
       <?php
                ...
                if (\Input::has('status'))
				{
					$status_append = "&status=".\Input::get('status');					
				}
				$product_append = "";
				if (\Input::has('product'))
				{
					$product_append = "&product=".\Input::get('product');					
				}
				
       ?>  
        <div class="col-sm-2 action-nav-button">
            <a href= "{{ url() }}/admin/orders?export=true<?php echo $status_append;?><?php echo $product_append;?>" title="Statuses">
